// import { FichereparationService } from './fichereparation.service';
// import { Body, Controller, Delete, Get, Param, Post, Put } from '@nestjs/common';
// import { Demande } from 'src/demande/demande.entity';
// import { DeleteResult } from 'typeorm';

// @Controller('fichereparation')
// export class FichereparationController {
//   constructor(private service: FichereparationService) {}
...
//   @Get('/:id')
//   getById(@Param('id') id: number): Demande {
