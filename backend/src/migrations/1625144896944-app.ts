...
export class app1625144896944 implements MigrationInterface {
    name = 'app1625144896944'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `demande` DROP FOREIGN KEY `FK_64ec57f2001a4de268fea14cd7c`");
        ...
        await queryRunner.query("ALTER TABLE `demande` ADD CONSTRAINT `FK_64ec57f2001a4de268fea14cd7c` FOREIGN KEY (`distributeurId`) REFERENCES `distributeur`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `demande` ADD CONSTRAINT `FK_a47a4b13ca41e84aaad47429d01` FOREIGN KEY (`createdById`) REFERENCES `user`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `demande` ADD CONSTRAINT `FK_64ec57f2001a4de268fea14cd7c` FOREIGN KEY (`distributeurId`) REFERENCES `distributeur`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
    }
